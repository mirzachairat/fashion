          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="owl-carousel owl-theme">
                ...
                <a href="single-product.html">
                  <div class="featured-item">
                    <img src="{{asset('/images/item-06.jpg')}}" alt="Item 6">
                    <h4>Urna ac diam</h4>
                    <h6>$65.00</h6>
                  </div>
                </a>
                <a href="single-product.html">
                  <div class="featured-item">
                    <img src="{{asset('/images/item-04.jpg')}}" alt="Item 7">
                ...
                <a href="single-product.html">
                  <div class="featured-item">
                    <img src="{{asset('/images/item-05.jpg')}}" alt="Item 8">
                ...
                <a href="single-product.html">
                  <div class="featured-item">
                    <img src="{{asset('/images/item-06.jpg')}}" alt="Item 9">
                    <h4>Cras tempus</h4>
                    <h6>$95.00</h6>
                  </div>
                </a>
